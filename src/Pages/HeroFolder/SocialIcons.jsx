...
const SocialIcons = () => {
  ...
  return (
    <>
      <aside className="absolute bottom-0 right-0 top-[5%] p-1 ml-[1rem] h-[fit-content] mt-[5rem] w-[fit-content] mr-[1rem] overflow-hidden">
        {/* likedin svg */}
        <a
          ...
          <svg
            ...
            className="w-[25px]  mb-[1.5rem] cursor-pointer animate-bounce"
            viewBox="0 0 448 512"
            fill={`${colorCode}`}>
        ...
        <a
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
            className="w-[25px] cursor-pointer animate-bounce"
            fill={`${colorCode}`}>
